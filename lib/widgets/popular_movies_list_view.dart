...
class _PopularMoviesListViewState extends State<PopularMoviesListView> {
  ...
  String searchUrl = 'https://api.themoviedb.org/3/movie/popular?api_key=53b6f70df0427cdf36b1c1679950f19b&language=en-US&page=1';
  ...
  Future<TrendingMovie> getSearchList() async {
    ...
    TrendingMovie popularMovies = TrendingMovie.fromJson(json);
