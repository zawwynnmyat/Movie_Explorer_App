...
class TrendingTVSeriesListView extends StatefulWidget {
  const TrendingTVSeriesListView({Key? key}) : super(key: key);


  @override
  State<TrendingTVSeriesListView> createState() => _TrendingTVSeriesListViewState();
}

class _TrendingTVSeriesListViewState extends State<TrendingTVSeriesListView> {
