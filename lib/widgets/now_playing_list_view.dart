...
class NowPlayingListView extends StatefulWidget {
  const NowPlayingListView({Key? key}) : super(key: key);
...
class _NowPlayingListViewState extends State<NowPlayingListView> {
  ...
  String searchUrl = 'https://api.themoviedb.org/3/movie/now_playing?api_key=53b6f70df0427cdf36b1c1679950f19b&language=en-US&page=1';
