...
class _SimilarViewState extends State<SimilarView> {
  ...
  Future<Movie> getRecommendMovies(int id) async {
    String jsonUrl = 'https://api.themoviedb.org/3/movie/' + id.toString() + '/similar?api_key=53b6f70df0427cdf36b1c1679950f19b&language=en-US&page=1';
    var response = await get(Uri.parse(jsonUrl));
    var json = jsonDecode(response.body);
    Movie similarMovie = Movie.fromJson(json);
