...
import 'package:movie_finder/model/movie_detail/movie_credit.dart';
...
class _CastWidgetState extends State<CastWidget> {
  ...
  Future<MovieCredit> getCastAndCrew(int id) async {
    ...
    MovieCredit movieCredit = MovieCredit.fromJson(json);
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<MovieCredit>(
